...
import com.example.yang.kuo.db.CoolWeatherOpenHelper;
...
public class CoolWeatherDB {
    ...
    public List<Province> loadProvinces() {
        ...
        Cursor cursor = db.query("Province", null, null, null, null, null, null);//游标查找
    ...
    public List<County> loadCountties(int cityId){
